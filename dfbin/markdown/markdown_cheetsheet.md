...
\\end{aligned}
<ul>
<li>\\(R_p\\) is the return on the portfolio </li>
<li>\\(R_i\\) is the return on asset ''i'' </li>
<li>\\(w_i\\)is the weighting of component asset i (that is, the proportion of asset "i" in the portfolio) </li>
</ul>
</div>
